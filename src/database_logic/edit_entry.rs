...
// Methods for editing records in the database

impl DataBase {
    /// Updates an existing participant's details in the `Participants` table.
    ///
    /// # Parameters
    /// - `participant`: The `Participant` struct containing updated information.
    ///
    /// # Returns
    /// - `Result<()>`: Returns `Ok(())` if the operation succeeds or an `Err` if it fails.
    ...
    /// Updates an existing support worker's details in the `Support_Workers` table.
    ///
    /// # Parameters
    /// - `support_worker`: The `SupportWorker` struct containing updated information.
    ///
    /// # Returns
    /// - `Result<()>`: Returns `Ok(())` if the operation succeeds or an `Err` if it fails.
    ...
    /// Updates an existing venue's details in the `Venues` table.
    ///
    /// # Parameters
    /// - `venue`: The `Venue` struct containing updated information.
    ///
    /// # Returns
    /// - `Result<()>`: Returns `Ok(())` if the operation succeeds or an `Err` if it fails.
    ...
    /// Updates an existing workshop's details in the `Workshops` table.
    ///
    /// # Parameters
    /// - `workshop`: The `Workshop` struct containing updated information.
    ///
    /// # Returns
    /// - `Result<()>`: Returns `Ok(())` if the operation succeeds or an `Err` if it fails.
